...
%type<ttype>     ResourceAnnotations
%type<ttype>     ResourceAnnotationList
%type<tannot>    ResourceAnnotation
%type<id>        ResourceAnnotationValue
...
Service:
  tok_service tok_identifier Extends '{' FlagArgs FunctionList UnflagArgs '}' TypeAnnotations ResourceAnnotations
    {
      ...
      if ($10 != NULL) {
        $$->resource_annotations_ = $10->annotations_;
        delete $10;
      }
    }
...
Function:
  CaptureDocText Oneway FunctionType tok_identifier '(' FieldList ')' Throws TypeAnnotations ResourceAnnotations CommaOrSemicolonOptional
    {
...
ResourceAnnotations:
  tok_resource '(' ResourceAnnotationList ')'
    {
      pdebug("ResourceAnnotations -> ( ResourceAnnotationList )");
      $$ = $3;
    }
|
    {
...
ResourceAnnotationList:
  ResourceAnnotationList ResourceAnnotation
    {
      pdebug("ResourceAnnotationList -> ResourceAnnotationList , ResourceAnnotation");
      $$ = $1;
      $$->annotations_[$2->key] = $2->val;
      delete $2;
    }
...
ResourceAnnotation:
  tok_identifier ResourceAnnotationValue CommaOrSemicolonOptional
    {
      pdebug("ResourceAnnotation -> ResourceAnnotationValue");
      $$ = new t_annotation;
      $$->key = $1;
      $$->val = $2;
    }

ResourceAnnotationValue:
  '=' tok_literal
    {
      pdebug("ResourceAnnotationValue -> = tok_literal");
      $$ = $2;
    }
